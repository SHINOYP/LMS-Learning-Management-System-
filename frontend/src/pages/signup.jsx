...
const Signup = () => {
  ...
  return (
    <div className="login text-white flex items-center justify-center ">
      <img alt="" src={sqr} className="absolute top-0 left-0"></img>
      <img alt="" src={sqr2} className="absolute top-0 right-0"></img>
      <img alt="" src={sqr3} className="absolute bottom-0 left-0"></img>
      <img alt="" src={sqr4} className="absolute bottom-0 right-0"></img>
