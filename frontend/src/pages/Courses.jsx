    ...
    return(
        <div> 
            <div className="flex  flex-col justify-between mx-4">
                <h1 className="ml-10 mt-10 mb-4 text-xl font-black  flex"> <ClassIcon className="mx-2 my-auto" />Your Courses</h1>
                <div className="inline-flex text-white  mx-auto my-6" role="group">
                    <button type="button"  onClick={()=>setButtonPopup(true)}  className="inline-flex items-center px-32 py-4 mx-4  rounded-xl drop-shadow-md text-sm   font-black font-medium  transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ">
                       <LibraryAddIcon className="mr-2"/> Add New Course
                    </button>
                    <Link to='/profile' type="button" className="inline-flex items-center px-32 py-4 mx-4  rounded-xl drop-shadow-md  text-sm  font-black font-medium transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
                        <AccountBoxIcon className="mr-2"/>
                        Profile
                    </Link>
                   
                    <button type="button" class="inline-flex items-center px-32 py-4  rounded-xl mx-4 drop-shadow-md text-sm font-black font-medium  transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
