    ...
    <div className="flex my-4 flex-col relative  w-80 mx-10  bg-white border-solid rounded-lg drop-shadow-2xl  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 ">
         <div className="border-white   w-72 ">
            {location.pathname !=="/Dashboard" && 
                <button onClick={handleClick} className="cursor-not-allowed absolute left-3 top-2 "><DeleteIcon className="transform h-64 w-1/5  transition duration-800 hover:scale-150" style={{ fill: 'red' ,fontSize:'25px'}}/><span className="text-sm">Delete </span></button>
            }   
            <img src={props.chapter.img} 
                onError={({ currentTarget }) => {
                    currentTarget.onerror = null; // prevents looping
                    currentTarget.src="https://img.freepik.com/free-vector/online-tutorials-concept_52683-37480.jpg?w=1380&t=st=1678376734~exp=1678377334~hmac=5c4cfbd4678e55f5b00ee505e37fd7c2474945362aa7c577172fcc9863fa764c";
                }}   
        ...
        <Link to="/OpenCourse" state={chapterd} >
            <div className=" flex  flex-col bg-white border-b  h-14   mt-2">
                ...
                <p className="mx-auto text-xs"><PersonIcon sx={{ fontSize: 14 }} className=" mr-1"/>Lecture</p>
            </div>
